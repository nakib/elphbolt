...
| ~print_aniso_gap~  | Logical | .False. | Print out the anisotropic gap function?                                                                                                          |
...
| ~aniso_quasiparticle_Delta.T~      | ~./~                 | eV                | Anisotropic superconducting gap on the equidistant electronic quasiparticle energy mesh for each IBZ electronic state within the Fermi window. The first column gives the number of FBZ images of the IBZ point. |
