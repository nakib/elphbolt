...
|---------------+------------------+--------+-----------------------------------------------------------------------------|
| ~gk2.istate*~ | ~datadumpdir/g2~ | eV^{2} | Squared e-ph vertices for every IBZ electron state. This is a binary file . |
| ~gq2.istate*~ | ~datadumpdir/g2~ | eV^{2} | Squared e-ph vertices for every IBZ electron state. This is a binary file . |
|               |                  |        |                                                                             |
