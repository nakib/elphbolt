...
**** Using ~cmake~ [Deprecated]
     I am sunsetting the ~cmake~ build. You are on your own to figure out how to use it. Something like the following should work after you have fiddled with the like ~CMakeLists.txt~:
