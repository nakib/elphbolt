...
~OpenCoarrays~ ([[http://www.opencoarrays.org]]) is an implementation of the ~coarrays~ functionalities. Follows its installation guide to build it on your system. I personally like to use its install script where I pass my compiler and MPI relared flags explicitly.
...
***** Experimental method (with gpu)
	...
	fpm test bte_regression --runner="sh test/3C-SiC/fpm_run_bte_caf.sh"
      ...
      Here I have assumed that you have already done ~blas~ and ~lapack~ building step.
