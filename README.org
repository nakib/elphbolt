...
Issue the following commands to build and run tests: ~mkdir build; cd build; cmake ..; make; ctests~. If all goes well, the exectuable will be available as ~build/bin/elphbolt~.
