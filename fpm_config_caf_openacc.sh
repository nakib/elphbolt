...
export FPM_FFLAGS="-g -O2 -cpp -fopenacc -fopt-info-omp -DOPENACC=1 -foffload=-lm -foffload=nvptx-none -no-pie -fPIC -Wunused -Wconversion -Wunderflow -Wdo-subscript -L $FORBLASLAPACK_DIR"
