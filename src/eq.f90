module my_optimization_data
  IMPLICIT NONE
  INTEGER, PARAMETER :: wp = KIND( 1.0D+0 ) ! set precision
  REAL( KIND = wp ) :: param1
  ! This module holds your extra parameters
end module my_optimization_data

module my_optimization_routines
  use my_optimization_data
contains
  SUBROUTINE FUN ( X, F, i )
    ...
    IF ( .NOT. PRESENT( i ) ) THEN
       ...
       !==============================================================================
       F = param1*(X(2)-X(1)**2)**2 +(1.0_wp-X(1))**2 !
       !==============================================================================
    ELSE
       SELECT CASE ( i )
       CASE ( 1 )
...
end module my_optimization_routines
