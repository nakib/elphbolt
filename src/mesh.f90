module mesh
  ...
  !! full and irreducible wave vector meshes and various index mappings.
  ...
  use data, only: el_ibz2fbz_map, el_indexlist_irred, el_nequiv, el_wavevecs, &
       ...
       el_fbz2ibz_map, nstates_irred_inwindow, IBZ_inwindow_states, cwd
  
  implicit none

  private 
  public calculate_electrons
